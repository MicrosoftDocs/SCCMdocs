...
|Migrate App-V 5 connection groups to Configuration Manager virtual environments.|See the [Migrate App-V 5 connection groups to Configuration Manager virtual environments](/sccm/apps/get-started/deploying-app-v-virtual-applications#migrating-app-v-5-connection-groups-to-configuration-manager-virtual-environments) section in this topic.|  

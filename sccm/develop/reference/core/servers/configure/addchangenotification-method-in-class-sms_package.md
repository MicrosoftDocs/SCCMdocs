...
The `AddChangeNotification` Windows Management Instrumentation (WMI) class method, in System Center Configuration Manager, adds a package change notification.  

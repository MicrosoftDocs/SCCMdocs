...
-   [SMS_CM_RES_COLL_CollectionID Server WMI Class](../../../../../develop/reference/core/clients/collections/sms_cm_res_coll_collectionid-server-wmi-class.md)  

-   [SMS_Collection Server WMI Class](../../../../../develop/reference/core/clients/collections/sms_collection-server-wmi-class.md)  

-   [SMS_CollectionBucket Server WMI Class](../../../../../develop/reference/core/clients/collections/sms_collectionbucket-server-wmi-class.md)  

-   [SMS_CollectionDependencies Server WMI Class](../../../../../develop/reference/core/clients/collections/sms_collectiondependencies-server-wmi-class.md)  
...
-   [SMS_CollectionPermission Server WMI Class](../../../../../develop/reference/core/clients/collections/sms_collectionpermission-server-wmi-class.md)  
...
-   [SMS_CollectionRuleExcludeCollection Server WMI Class](../../../../../develop/reference/core/clients/collections/sms_collectionruleexcludecollection-server-wmi-class.md)  

-   [SMS_CollectionRuleIncludeCollection Server WMI Class](../../../../../develop/reference/core/clients/collections/sms_collectionruleincludecollection-server-wmi-class.md)  
...
-   [SMS_CollectionToPkgAdvert_a Server WMI Class](../../../../../develop/reference/core/clients/collections/sms_collectiontopkgadvert_a-server-wmi-class.md)  
...
-   [SMS_CombinedResources Server WMI Class](../../../../../develop/reference/core/clients/collections/sms_combinedresources-server-wmi-class.md)  
...
-   [SMS_DirFullCollMem Server WMI Class](../../../../../develop/reference/core/clients/collections/sms_dirfullcollmem-server-wmi-class.md)  

...
|[AddDistributionPoints Method in Class SMS_VhdPackage](../../../develop/reference/osd/adddistributionpoints-method-in-class-sms_vhdpackage.md)|Adds the distribution points for the package.|  
|[GetImageProperties Method in Class SMS_VhdPackage](../../../develop/reference/osd/getimageproperties-method-in-class-sms_vhdpackage.md)|Reads all image properties from the specified WIM file to an XML string.|  
|[RefreshPkgSource Method in Class SMS_VhdPackage](../../../develop/reference/osd/refreshpkgsource-method-in-class-sms_vhdpackage.md)|Refreshes the package source at all distribution points, when the package properties have not changed.|  
|[ReloadImageProperties Method in Class SMS_VhdPackage](../../../develop/reference/osd/reloadimageproperties-method-in-class-sms_vhdpackage.md)|Reloads image properties from source WIM file and updates the database.|  

...
- [Create a phased deployment](/sccm/osd/deploy-use/create-phased-deployments?toc=/sccm/apps/toc.json&bc=/sccm/apps/breadcrumb/toc.json)  
...
For more information, see [Create a phased deployment with manually configured phases](/sccm/osd/deploy-use/create-phased-deployments#bkmk_manual).
...
For more information, see [Phase settings](/sccm/osd/deploy-use/create-phased-deployments#bkmk_settings).  

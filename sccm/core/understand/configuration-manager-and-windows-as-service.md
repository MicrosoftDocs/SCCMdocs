...
|[Phased deployments](/sccm/osd/deploy-use/create-phased-deployments)|Phased deployments automate a coordinated, sequenced rollout of a task sequence across multiple collections.|  
